...
//Get the value of the textbox with id, todoItem. Save the value inside variable called todoItemValue.
 ...
 let newUrgentItems = urgentItems +'<li class="list-group-item display-7">' + "<h3>"+ todoItemValue + "</h3>"  + todoDescriptionValue + '   <button onclick="deleteItem(this)" class="text-danger" title="delete this todo"><span class="fa fa-trash"></span></button><button onclick="completeItem(this)" class="text-success" title="complete this todo"><span class="fa fa-check"></span></button><td>';
